...
def generate_RSA_key():
    private_rsa_key = rsa.generate_private_key(public_exponent=65537, key_size=2048) # Generate a 2048 bits RSA key
    ...
    with open(r"C:\Users\User\Desktop\Lockscope\Keys\RSA_private_key.pem", 'w') as private_rsa_key_file:
        private_rsa_key_file.write(pem_private_rsa_key.decode())
    
    with open(r"C:\Users\User\Desktop\Lockscope\Keys\RSA_public_key.pem", 'w') as public_rsa_key_file:
        public_rsa_key_file.write(pem_public_rsa_key.decode())
